...
@Component({
  selector: 'app-menu-alumad',
  templateUrl: './menu-alumad.component.html',
  styleUrls: ['./menu-alumad.component.css']
})
export class MenuAlumadComponent implements OnInit {
  title = 'Rivera Designs / Alumad'
  ...
  ngOnInit(): void {
    ...
    this.metaService.addTags([
      ...
      {name: 'description', content: 'Colección Alumad'},
