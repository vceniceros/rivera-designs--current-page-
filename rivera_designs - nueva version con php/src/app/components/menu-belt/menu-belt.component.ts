...
@Component({
  selector: 'app-menu-belt',
  templateUrl: './menu-belt.component.html',
  styleUrls: ['./menu-belt.component.css']
})
export class MenuBeltComponent implements OnInit {
  title = 'Rivera Designs / Belt'
  ...
  ngOnInit(): void {
    ...
    this.metaService.addTags([
      ...
      {name: 'description', content: 'Colección Belt'},
